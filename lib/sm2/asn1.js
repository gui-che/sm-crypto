...
var ASN1Object = function () {
    function ASN1Object() {
        (0, _classCallCheck3['default'])(this, ASN1Object);
    ...
    (0, _createClass3['default'])(ASN1Object, [{
...
var DERInteger = function (_ASN1Object) {
    (0, _inherits3['default'])(DERInteger, _ASN1Object);

    function DERInteger(options) {
        (0, _classCallCheck3['default'])(this, DERInteger);

        var _this = (0, _possibleConstructorReturn3['default'])(this, (DERInteger.__proto__ || Object.getPrototypeOf(DERInteger)).call(this));
    ...
    (0, _createClass3['default'])(DERInteger, [{
        key: 'getFreshValueHex',
        value: function getFreshValueHex() {
            return this.hV;
        }
...
var DERSequence = function (_ASN1Object2) {
    (0, _inherits3['default'])(DERSequence, _ASN1Object2);

    function DERSequence(options) {
        (0, _classCallCheck3['default'])(this, DERSequence);

        var _this2 = (0, _possibleConstructorReturn3['default'])(this, (DERSequence.__proto__ || Object.getPrototypeOf(DERSequence)).call(this));
    ...
    (0, _createClass3['default'])(DERSequence, [{
        key: 'getFreshValueHex',
        value: function getFreshValueHex() {
            var h = '';
...
function getIntOfL(s, pos) {
    ...
    if (parseInt(hLength.substring(0, 1)) < 8) {
        bi = new _jsbn.BigInteger(hLength, 16);
    } else {
        bi = new _jsbn.BigInteger(hLength.substring(2), 16);
    }
    return bi.intValue();
}
...
function decodeDer(input) {
    ...
    var r = new _jsbn.BigInteger(hR, 16);
    var s = new _jsbn.BigInteger(hS, 16);
